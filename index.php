...
$lots_list = [
    ...
    [
        'nameLot' => 'DC Ply Mens 2016/2017 Snowboard',
        'category' => 'Доски и лыжи',
        'price' => '159999',
        'url' => 'img/lot-2.jpg'
    ],
    [
        'nameLot' => 'Крепления Union Contact Pro 2015 года размер L/XL',
        'category' => 'Крепления',
        'price' => '8000',
        'url' => 'img/lot-3.jpg'
    ],
    [
        'nameLot' => 'Ботинки для сноуборда DC Mutiny Charocal',
        'category' => 'Ботинки',
        'price' => '10999',
        'url' => 'img/lot-4.jpg'
    ],
    [
        'nameLot' => 'Куртка для сноуборда DC Mutiny Charocal',
        'category' => 'Одежда',
        'price' => '7500',
        'url' => 'img/lot-5.jpg'
    ],
    [
        'nameLot' => 'Маска Oakley Canopy',
        'category' => 'Разное',
        'price' => '5400',
        'url' => 'img/lot-6.jpg'
    ]
...
function formatPrice($price)
{
    ...
    if ($result < 1000) {
        return $result;
    } elseif ($result === 1000 || $result > 1000) {
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$lot['nameLot']; ?></a></h3>
